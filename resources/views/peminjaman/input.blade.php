...
<style>
  .form-control {
    border: 1px solid #9096f3; /* Warna border default Bootstrap */
  ...
  .form-group-box {
    border: 1px solid #ffffff; /* Border abu-abu terang untuk kotak form group */
    padding: 15px;
    border-radius: 5px;
    margin-bottom: 15px; /* Jarak antara form group */
    background-color: #ffffff; /* Warna latar belakang ringan untuk form group */
  }
</style>
